...
const STOP_WORDS = new Set([
  // Русские
  "и","в","во","на","не","что","с","со","как","по","для","из","от","за","при",
  "или","это","то","же","бы","а","но","к","о","об","если","до",
  // Английские
  "the","a","an","of","and","or","to","in","for","with","on","at","is",
  // Домен 1С
  "1с","бит","1с.бит","пользователя","инструкция","документ","порядок",
  "формирование","например","также","данные","значения","значение",
  "поля","поле","рисунок"
]);
...
/**
 * Токенизирует строку — та же логика что в knowledge_base.js
 * @param {string} text
 * @returns {string[]}
 */
